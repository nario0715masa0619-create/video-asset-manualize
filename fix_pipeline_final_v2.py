"""
Phase 6 build_training_asset_pipeline 最終修正v2
"""
...
class BuildTrainingAssetPipeline:
    ...
    def generate_outputs(
        ...
        if format in ["html", "all"]:
            ...
            self.html_renderer.render_to_file(self.spec, str(html_path))
        ...
        if format in ["pdf", "all"]:
            ...
            self.pdf_renderer.render_to_file(self.spec, str(pdf_path))
...
print("\nOK: Both HTML and PDF use render_to_file")
