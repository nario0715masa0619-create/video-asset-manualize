"""
Phase 6 build_asset 完全再生成スクリプト
"""
...
build_asset_file.write_text(new_content, encoding='utf-8')
print("✓ Regenerated: src/video_asset_manualize/build_asset.py")
print("\n✅ build_asset.py が完全に再生成されました")
