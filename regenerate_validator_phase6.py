"""
Phase 6 source_evidence_validator 完全再生成スクリプト
"""
...
validator_file.write_text(new_content, encoding='utf-8')
print("✓ Regenerated: src/video_asset_manualize/source_evidence_validator.py")
print("\n✅ source_evidence_validator.py が完全に再生成されました")
