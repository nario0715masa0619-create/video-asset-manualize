"""
source_evidence_to_training_asset_builder.py を根本修正
source_evidence セクションのフィールド名をスキーマに合わせる
"""
...
print("✓ source_evidence_to_training_asset_builder.py を根本修正しました")
print("  source_evidence セクションを削除して、必須フィールドのみ生成")
